...
${OBJECTDIR}/FCFSScheduler.o: FCFSScheduler.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FCFSScheduler.o FCFSScheduler.c

${OBJECTDIR}/Lottery_Scheduler.o: Lottery_Scheduler.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Lottery_Scheduler.o Lottery_Scheduler.c

${OBJECTDIR}/PiCalculator.o: PiCalculator.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PiCalculator.o PiCalculator.c
