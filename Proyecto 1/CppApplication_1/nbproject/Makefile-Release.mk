...
${OBJECTDIR}/_ext/5c0/FCFSScheduler.o: ../FCFSScheduler.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/FCFSScheduler.o ../FCFSScheduler.c

${OBJECTDIR}/_ext/5c0/PiCalculator.o: ../PiCalculator.c
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/PiCalculator.o ../PiCalculator.c

${OBJECTDIR}/_ext/5c0/Scheduler.o: ../Scheduler.c
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/Scheduler.o ../Scheduler.c
