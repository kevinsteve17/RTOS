...
\tiny T3& &  &  &  \cellcolor{blue}&  \cellcolor{blue}&  &  \cellcolor{blue}&  \cellcolor{blue}&  &  &  \cellcolor{blue}&  \cellcolor{blue}&  \cellcolor{white}&  \cellcolor{white}&  \cellcolor{white}&  &  \cellcolor{white}&  \cellcolor{white}&  \cellcolor{white}&  \cellcolor{blue}&  &  \cellcolor{blue}&  \cellcolor{blue}&  \cellcolor{blue}&  &  &  &  \cellcolor{blue}&  \cellcolor{blue}&  \cellcolor{white}&  &  \cellcolor{white}&  &  &  \cellcolor{white}&  &  \cellcolor{white}&  \cellcolor{white}&  \cellcolor{blue}&  \cellcolor{blue}&  &  &  &  \cellcolor{blue}&  \cellcolor{blue}&  &  \cellcolor{blue}&  \cellcolor{blue}&  \cellcolor{white}&  \cellcolor{white}&  &  \cellcolor{white}&  \cellcolor{white}&  \cellcolor{white}&  \cellcolor{white}&  &  \cellcolor{white}&  \cellcolor{blue}&  \cellcolor{blue}&  \cellcolor{blue}&  &  \cellcolor{blue}&  \cellcolor{blue}&  \cellcolor{blue}&\\ \hline
\end{tabular}
\end{table}
\end{frame}
\end{document}
